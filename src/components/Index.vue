<template>
  ...
  <script lang="ts">
    ...
    const stringn3 = "hover:bg-purple-500 cursor-pointer max-w-full text-2xl p-4 shadow rounded font-bold text-white bg-purple-400 text-center"
    const stringn4 = "leading-none sm:leading-relaxed text-center block mt-24 w-full lg:w-2/3 xl:w-1/2"
